    ...
    'routes' => [
      'zonecode' => [
            ...
            'options' => [
                ...
                'defaults' => [
                    'controller' => Controller\ZoneCodeController::class,
                    'action' => 'index',
...
$controllers = [
    'factories' => [
        Controller\ZoneCodeController::class => Factory\ZoneCodeControllerFactory::class
    ]
];

$service_manager = [
    'factories' => [  
        Service\ZoneCodeManager::class => Factory\ZoneCodeManagerFactory::class,        
    ],
];
$view_manager = [
    'strategies' => [
