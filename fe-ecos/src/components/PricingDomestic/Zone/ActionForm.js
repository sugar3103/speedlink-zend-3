...
import { toggleZoneDomesticModal, changeTypeZoneDomesticModal } from '../../../redux/actions';
    ...
    return (
      <form className="form" onSubmit={handleSubmit}>
        ...
        <ButtonToolbar className="modal__footer">
          ...
          <Can user={this.props.authUser.user} permission="zone_domestic" action="edit" own={modalData && modalData.created_by}>
