...
import { toggleCountryModal, changeTypeCountryModal } from '../../../../redux/actions';
...
class ActionForm extends Component {
  ...
  changeTypeModal = () => {
    this.props.changeTypeCountryModal(MODAL_VIEW);
  }
  ...
  render() {
    ...
    switch (modalType) {
      case MODAL_ADD:
        className = 'success';
        title = messages['country.add-new'];
        break;
      case MODAL_EDIT:
        className = 'primary';
        title = messages['country.update'];
        break;
      case MODAL_VIEW:
        className = 'info';
        title = messages['country.view'];
        break;
      default:
        break;
    }
    return (
      <form className="form" onSubmit={handleSubmit}>
        ...
        <ButtonToolbar className="modal__footer">
          ...
          <Can user={this.props.authUser.user} permission="masterdata_country" action="edit" own={modalData && modalData.created_by}>
...
const mapStateToProps = ({ address, authUser }) => {
  const { modalData, modalType } = address.country;
  return {
    modalData,
    modalType,
    authUser
