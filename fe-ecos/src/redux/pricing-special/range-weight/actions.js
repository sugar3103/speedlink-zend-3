...
export const resetDataImportRangeWeightSpecial = () => ({
  type: PRI_SPECIAL_RANGE_WEIGHT_RESET_DATA_IMPORT,
});

export const getDataImportRangeWeightSpecial = (params) => ({
  type: PRI_SPECIAL_RANGE_WEIGHT_GET_DATA_IMPORT,
  payload: { params }
});
