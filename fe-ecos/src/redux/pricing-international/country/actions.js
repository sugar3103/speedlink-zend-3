...
export const getPricingCountryInternationalList = (params) => ({
  type: PRI_INT_PRICING_COUNTRY_GET_LIST,
  payload: { params }
});

export const getPricingCountryInternationalListSuccess = (items) => ({
  type: PRI_INT_PRICING_COUNTRY_GET_LIST_SUCCESS,
