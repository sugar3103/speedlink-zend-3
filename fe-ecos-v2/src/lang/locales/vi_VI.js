...
module.exports = {
  ...
  "branch.inactive": "Không kích hoạt",
  "branch.search": "Tìm kiếm",
  "branch.clear": "Làm mới",
  "branch.description": "Mô tả",
  "branch.action": "Hành động",
  "branch.export": "Xuất",
  "branch.cancel": "Hủy",
  "branch.submit": "Lưu",
  "branch.title-confirm": "Bạn chắc chắn?",
  "branch.desc-confirm": "Bạn muốn xóa trạng thái này?",
  "branch.confirm-no": "Không",
  "branch.confirm-yes": "Có, xóa nó!",
  "branch.address": "Địa chỉ",
  "branch.hub": "Hub",
  "branch.city": "Tỉnh/Thành phố",
  "branch.district": "Quận/Huyện",
  "branch.ward": "Phường/Xã",
  "branch.country": "Quốc gia",
