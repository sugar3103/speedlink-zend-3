...
class User
{
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="last_token_create_at", type="datetime", nullable=true)
     */
    private $last_token_create_at;
    ...
    {
        return $this->last_token_create_at;
    }

    /**
     * @param \DateTime|null $last_token_create_at
     */
    public function setLastTokenCreateAt($last_token_create_at)
    {
        $this->last_token_create_at = $last_token_create_at;
    }
