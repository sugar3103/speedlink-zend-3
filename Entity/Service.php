...
class Service
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="service_name_en", type="string", length=50, nullable=true)
     */
    private $serviceNameEn;
     ...
     * @var string|null
     *
     * @ORM\Column(name="service_code", type="string", length=50, nullable=true, options={"fixed"=true})
     */
    private $serviceCode;
