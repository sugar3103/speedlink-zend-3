...
class ShipmentType
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="shipment_type_name", type="string", length=50, nullable=true)
     */
    private $shipmentTypeName;

    /**
     * @var string|null
     *
     * @ORM\Column(name="shipment_type_name_en", type="string", length=50, nullable=true)
     */
    private $shipmentTypeNameEn;
     ...
     * @var string|null
     *
     * @ORM\Column(name="shipment_type_code", type="string", length=50, nullable=true, options={"fixed"=true})
     */
